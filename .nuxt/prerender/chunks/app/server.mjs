import { getCurrentInstance, version, inject, defineComponent, h, onUnmounted, computed, unref, Suspense, nextTick, Transition, provide, reactive, shallowRef, isReadonly, ref, resolveComponent, watch, Fragment as Fragment$1, useSSRContext, createApp, toRef, isRef, effectScope, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createVNode, Text, withCtx } from 'file:///home/rasel/Public/safwat-nuxt-frontend/node_modules/vue/index.mjs';
import { $fetch } from 'file:///home/rasel/Public/safwat-nuxt-frontend/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///home/rasel/Public/safwat-nuxt-frontend/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///home/rasel/Public/safwat-nuxt-frontend/node_modules/unctx/dist/index.mjs';
import { useHead, createHead as createHead$1 } from 'file:///home/rasel/Public/safwat-nuxt-frontend/node_modules/@unhead/vue/dist/index.mjs';
import { renderDOMHead, debouncedRenderDOMHead } from 'file:///home/rasel/Public/safwat-nuxt-frontend/node_modules/@unhead/dom/dist/index.mjs';
import { renderSSRHead } from 'file:///home/rasel/Public/safwat-nuxt-frontend/node_modules/@unhead/ssr/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, useRouter as useRouter$1 } from 'file:///home/rasel/Public/safwat-nuxt-frontend/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sendRedirect } from 'file:///home/rasel/Public/safwat-nuxt-frontend/node_modules/h3/dist/index.mjs';
import { hasProtocol, parseURL, joinURL, isEqual } from 'file:///home/rasel/Public/safwat-nuxt-frontend/node_modules/ufo/dist/index.mjs';
import { CoreWarnCodes, CompileErrorCodes, registerMessageResolver, resolveValue, registerLocaleFallbacker, fallbackWithLocaleChain, setDevToolsHook, createCompileError, DEFAULT_LOCALE as DEFAULT_LOCALE$1, updateFallbackLocale, NUMBER_FORMAT_OPTIONS_KEYS, DATETIME_FORMAT_OPTIONS_KEYS, setFallbackContext, createCoreContext, clearDateTimeFormat, clearNumberFormat, setAdditionalMeta, getFallbackContext, NOT_REOSLVED, isTranslateFallbackWarn, isTranslateMissingWarn, parseTranslateArgs, translate, MISSING_RESOLVE_VALUE, parseDateTimeArgs, datetime, parseNumberArgs, number } from 'file:///home/rasel/Public/safwat-nuxt-frontend/node_modules/@intlify/core-base/dist/core-base.mjs';
import { setupDevtoolsPlugin } from 'file:///home/rasel/Public/safwat-nuxt-frontend/node_modules/vue-devtools-stub/dist/index.mjs';
import { VueDevToolsLabels, VueDevToolsPlaceholders, VueDevToolsTimelineColors } from 'file:///home/rasel/Public/safwat-nuxt-frontend/node_modules/@intlify/vue-devtools/dist/vue-devtools.mjs';
import { parse, serialize } from 'file:///home/rasel/Public/safwat-nuxt-frontend/node_modules/cookie-es/dist/index.mjs';
import isHTTPS from 'file:///home/rasel/Public/safwat-nuxt-frontend/node_modules/is-https/dist/index.mjs';
import { config, library } from 'file:///home/rasel/Public/safwat-nuxt-frontend/node_modules/@fortawesome/fontawesome-svg-core/index.mjs';
import { FontAwesomeIcon } from 'file:///home/rasel/Public/safwat-nuxt-frontend/node_modules/@fortawesome/vue-fontawesome/index.js';
import { faPlus, faMinus, faCheck, faAngleDown, faCircleCheck } from 'file:///home/rasel/Public/safwat-nuxt-frontend/node_modules/@fortawesome/free-solid-svg-icons/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent } from 'file:///home/rasel/Public/safwat-nuxt-frontend/node_modules/vue/server-renderer/index.mjs';
import { defu } from 'file:///home/rasel/Public/safwat-nuxt-frontend/node_modules/defu/dist/defu.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./_nuxt/index-881a2bc0.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.name) ?? "index___ar",
    path: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.path) ?? "/ar",
    children: [],
    meta: __nuxt_page_meta$2,
    alias: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.alias) || [],
    redirect: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.redirect) || void 0,
  ...
  {
    name: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name) ?? "message___en",
    path: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) ?? "/message",
    children: [],
    meta: __nuxt_page_meta$1,
    alias: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.alias) || [],
    redirect: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.redirect) || void 0,
    component: () => import('./_nuxt/message-70c14cf3.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name) ?? "message___ar",
    path: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) ?? "/ar/message",
    children: [],
    meta: __nuxt_page_meta$1,
    alias: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.alias) || [],
    redirect: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.redirect) || void 0,
  ...
  {
    name: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) ?? "product___en",
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/product",
    children: [],
    meta: __nuxt_page_meta,
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_nuxt/product-810e98d0.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) ?? "product___ar",
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/ar/product",
    children: [],
    meta: __nuxt_page_meta,
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
...
const namedMiddleware = {
  add: () => import('./_nuxt/add-70c423f4.mjs')
};
...
const resolveNuxtI18nOptions = async (context) => {
  ...
  const vueI18nOptionsLoader = async (context2) => Object({ "locale": "en", "fallbackLocale": "en", "messages": Object({ "en": {
    "hello": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["Hellow"]);
    },
    "welcome": (ctx) => {
      const { normalize: _normalize } = ctx;
    ...
    "hello": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["مرحبًا"]);
    },
    "welcome": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["أهلا بك"]);
    }
  } }) });
...
const nuxtI18nInternalOptions = Object({ __normalizedLocales: [Object({ "code": "en", "iso": "en-US", "file": "en.js" }), Object({ "code": "ar", "iso": "ar-EG", "file": "ar.js" })] });
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component-4ca7ef81.mjs').then((r) => r.default || r));
    const IslandRendererer = defineAsyncComponent(() => import('./_nuxt/island-renderer-54cad251.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, __nuxt_component_0$1 as a, useNuxtApp as b, createError as c, defineNuxtRouteMiddleware as d, entry$1 as default, navigateTo as n, useRoute as u };
